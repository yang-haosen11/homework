...
When simplifying assumptions (known object poses, simple convex shapes, static scene) cannot
...
subtraction via RANSAC-based ground-plane fitting \citep{thrun2005probabilistic}.
...
Dynamic RRT or a gradient-based trajectory optimiser (\eg, CHOMP, which optimises
trajectories by minimising obstacle-cost and smoothness potentials) can be used.
